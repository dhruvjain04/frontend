 ...
 // console.log(localStorage.getItem('token'));
  ...
  const fetchaccount= async ()=>
  {
    ...
    try{
      ...
      const response=await axios.get("https://backend-portal.onrender.com/farmer/myaccount",
      {
        headers:
        {
  ...
  const handleDeleteClick =async (ProdID) => {
    ...
    console.log(ProdID);
        try {
          const response = await axios.delete('https://backend-portal.onrender.com/farmer/product/'+ProdID, {     headers:
          {
              Authorization: 'Bearer ' + localStorage.getItem('token')
          } });
          fetchaccount();
